...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , hresetn{vlSymsp->TOP.hresetn}
    , hburst{vlSymsp->TOP.hburst}
    , hmastlock{vlSymsp->TOP.hmastlock}
    , hprot{vlSymsp->TOP.hprot}
    , hsize{vlSymsp->TOP.hsize}
    , hnonsec{vlSymsp->TOP.hnonsec}
    , hexcl{vlSymsp->TOP.hexcl}
    , hmaster{vlSymsp->TOP.hmaster}
    , htrans{vlSymsp->TOP.htrans}
    , hwrite{vlSymsp->TOP.hwrite}
    , hready{vlSymsp->TOP.hready}
    , hreadyout{vlSymsp->TOP.hreadyout}
    , hresp{vlSymsp->TOP.hresp}
    , hexokay{vlSymsp->TOP.hexokay}
    , hsel{vlSymsp->TOP.hsel}
